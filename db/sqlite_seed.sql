...
VALUES 
    ('Elegant Tote Bag', 'Bags', 89.99, 99.99, 'A stylish and elegant tote bag perfect for everyday use. Made with premium materials and designed for durability and fashion.', 'Premium Leather', '30cm x 40cm x 10cm', 800, 4.5, 128, 'https://placehold.co/400x400/pink/white?text=Elegant+Tote+Bag', 1, 1, 'In Stock'),
    ('Leather Wallet', 'Accessories', 45.00, 55.00, 'A premium leather wallet with multiple card slots and compartments. Slim design fits perfectly in your pocket.', 'Genuine Leather', '10cm x 8cm x 1cm', 150, 4.2, 85, 'https://via.placeholder.com/400?text=Wallet', 0, 0, 'In Stock'),
    ('Fashion Bracelet', 'Jewelry', 29.99, NULL, 'A beautiful fashion bracelet that adds elegance to any outfit. Perfect for daily wear or special occasions.', 'Stainless Steel, Cubic Zirconia', 'Adjustable', 50, 4.8, 64, 'https://via.placeholder.com/400?text=Bracelet', 1, 0, 'Low Stock'),
    ('Stylish Sunglasses', 'Accessories', 59.99, 79.99, 'Trendy sunglasses with UV protection. Lightweight frame and polarized lenses for maximum comfort.', 'Acetate Frame, Polarized Lenses', 'Standard Size', 120, 4.0, 42, 'https://via.placeholder.com/400?text=Sunglasses', 0, 0, 'Out of Stock'),
    ('Designer Watch', 'Watches', 129.99, NULL, 'Elegant designer watch with premium materials. Water-resistant and perfect for any occasion.', 'Stainless Steel, Mineral Glass', '40mm Case', 180, 4.7, 93, 'https://via.placeholder.com/400', 1, 1, 'In Stock');
